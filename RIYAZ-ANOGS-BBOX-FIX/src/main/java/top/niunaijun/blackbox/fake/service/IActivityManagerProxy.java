...
public class IActivityManagerProxy extends ClassInvocationStub {
    ...
    public static class BindService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            Intent proxyIntent = BlackBoxCore.getBActivityManager().bindService(intent,connection == null ? null : connection.asBinder(),resolvedType,userId);
            args[2] = proxyIntent;
	...
	public static class CheckPermission extends MethodHook {
		...
		protected Object hook(Object who, Method method, Object[] args) throws Throwable {
			...
			int pid = args[1] instanceof Integer ? (int) args[1] : Integer.parseInt(args[1].toString());
			int uid = args[2] instanceof Integer ? (int) args[2] : Integer.parseInt(args[2].toString());
