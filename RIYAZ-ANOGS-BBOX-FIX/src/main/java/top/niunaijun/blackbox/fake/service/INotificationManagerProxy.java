...
//        Slog.d(TAG, "call: " + method.getName());
    ...
    public static class enqueueToast extends MethodHook {
    ...
    @ProxyMethod("enqueueToastForLog")
    public static class enqueueToastForLog extends MethodHook {
    ...
    @ProxyMethod("enqueueToastEx")
    public static class enqueueToastEx extends MethodHook {
    ...
    @ProxyMethod("cancelToast")
    public static class cancelToast extends MethodHook {
