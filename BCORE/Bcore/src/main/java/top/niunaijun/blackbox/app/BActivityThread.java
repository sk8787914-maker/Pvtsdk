...
// ========== MICROPHONE FIX - ADDED IMPORTS START ==========
import android.app.AppOpsManager;
import android.os.Process;
// ========== MICROPHONE FIX - ADDED IMPORTS END ==========
...
public synchronized void handleBindApplication(String str, String str2) {
    try {
        ...
        try {
            ...
            // ========== MICROPHONE FIX - ADDED CALL ==========
            forceGrantMicrophonePermission(makeApplication);
            // ========== MICROPHONE FIX END ==========
...
/*    public void loadXposed(Context context) {
    ...
    // ========== MICROPHONE FIX - ADDED METHOD ==========
    private void forceGrantMicrophonePermission(Context context) {
        if (context == null) return;
        if (Build.VERSION.SDK_INT >= 34) { // Android 14+
            try {
                AppOpsManager appOps = (AppOpsManager) context.getSystemService(Context.APP_OPS_SERVICE);
                // OP_RECORD_AUDIO = 42, MODE_ALLOWED = 0
                ...
                setMode.invoke(appOps, 42, Process.myUid(), context.getPackageName(), 0);
                Slog.d(TAG, "Microphone permission force granted for " + context.getPackageName());
            } catch (Exception e) {
                Slog.e(TAG, "Failed to force grant microphone permission", e);
            }
        }
    }
    // ========== MICROPHONE FIX END ==========
